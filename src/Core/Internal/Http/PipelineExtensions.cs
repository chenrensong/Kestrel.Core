...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Http
{
    public static class PipelineExtensions
    {
        ...
        public static unsafe void WriteAsciiNoValidation(ref this BufferWriter<PipeWriter> buffer, string data)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void WriteNumeric(ref this BufferWriter<PipeWriter> buffer, ulong number)
        {
